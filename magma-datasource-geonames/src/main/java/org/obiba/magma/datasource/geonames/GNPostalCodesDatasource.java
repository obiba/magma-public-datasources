...
public class GNPostalCodesDatasource extends AbstractDatasource {
  ...
  // TODO Add all the countries
  @Override
  protected Set<String> getValueTableNames() {
//    return ImmutableSet.of("CA");
  ...
  private enum COUNTRIES {
    ...
    HR, HU, IM, IN, IS, IT, JE, JP, LI,
    LK, LT, LU, MC, MD, MH, MK, MP, MQ, MX, MY, NL, NO, NZ, PH, PK, PL, PM, PR, PT, RE, RU, SE, SI, SJ, SK, SM, TH, TR,
    US, VA, VI, YT, ZA
  }
